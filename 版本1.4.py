...
class Stats:
    def __init__(self):
        self.ui = QUiLoader().load(r"1.6ui.ui")#加载ui
        self.window=QMainWindow()
        self.ui.setWindowTitle('五子棋')
        palette = QPalette()
        palette.setBrush(QPalette.Window,QBrush(QPixmap(r'C:\Users\Kyle Zhou\Desktop\课程设计项目\bg.jpg')))
    ...
    def play_game(self):
        box = QMessageBox()
        box.setWindowTitle('选择游戏模式')
        box.setIconPixmap(QPixmap(r"C:\Users\Kyle Zhou\Desktop\u=448237888,445645019&fm=26&fmt=auto.jpg").scaled(50, 50))
        box.setText('请选择游戏模式')
    ...
    def fun2(self):
        url = QUrl.fromLocalFile(r"C:\Users\Kyle Zhou\Downloads\13303.wav")
        content = QMediaContent(url)
        self.player = QMediaPlayer()
        self.player.setMedia(content)
        # self.player.setVolume(100)
        self.player.play()
        QMessageBox.about(self.window, '关于我们', 'Kyle_Zhou')
...
app = QApplication([])
app.setWindowIcon(QIcon(r"C:\Users\Kyle Zhou\Desktop\src=http___pic.noyes.cn_d_file_games_201807_2236_xamfasku54l68682.png&refer=http___pic.noyes.jpg"))
stats = Stats()
stats.ui.show()
app.exec_()