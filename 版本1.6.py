...
class Stats:
    ...
    def __init__(self):
        self.ui = QUiLoader().load(r"1.6ui.ui")
        self.window=QMainWindow()
        self.ui.setWindowTitle('五子棋')
        palette = QPalette()
        palette.setBrush(QPalette.Window,QBrush(QPixmap(r"1.3.jpg")))
    ...
    def fun2(self):
        QMessageBox.about(self.window, '关于我们', '任厚蕊 周茂森 石袁林 花语 马驰宇 舒叶')
    ...
    def handleCalc(self):
        ...
        class Gomoku:
            def __init__(s):
                pg.init()
                s.just_one=1
                s.gun_sound = pg.mixer.Sound("落子音效.mp3")
                s.gun_sound.set_volume(4)
                s.win_sound = pg.mixer.Sound("victory.mp3")
            ...
            def loop(s):#主循环
                ...
                while s.going:
                    ...
                    if s.chessboard.winner and s.just_one==1:
                        ...
                        box.setIconPixmap(
                            QPixmap(r"1.3.jpg").scaled(50,50))
        ...
        if __name__ == "__main__":
            ...
            game.loop()
app = QApplication([])
app.setWindowIcon(QIcon(r"首页背景图.jpg"))
stats = Stats()
stats.ui.show()
app.exec_()
