...
from machine_new1 import main1
from machine_new1 import yinyue
import time
...
class UI_interface:#ui界面和游戏界面
    def __init__(self):
        self.ui = QUiLoader().load(r"版本2.0的数据文件/2.6ui")#加载ui
...
#首先初始化各种音效、音乐。然后再是设置棋盘的各个属性，包括格子数量、边长、初始时左上角的坐标。
        ...
        class Gomoku:
            def __init__(s):
                ...
                s.font = pg.font.Font(u"C:\Windows\Fonts\Candarab.ttf", 24)  #设置字体
                s.going = True
            ...
            def draw(s):
                bg = pg.image.load(r"版本2.0的数据文件/1.jp.jpg")
